const menuData = {
    ...
    menu2: {
        ...
        images: [
            'websiteimages/phmenu1.png',
            'websiteimages/phmenu2.png',
            'websiteimages/phmenu3.png',
            'websiteimages/phmenu4.png',
            'websiteimages/phmenu5.png',
            'websiteimages/phmenu6.png',
            'websiteimages/phmenu7.png',
            'websiteimages/phmenu8.png',
            'websiteimages/phmenu9.png',
            'websiteimages/phmenu10.png'
        ],
        additionalContent: 'For more about The Pump House...,Click below to Visit the page.',
        bookingPage: 'pumhuse.html',
