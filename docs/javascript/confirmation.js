...
const customerName = urlParams.get('customerName') || 'platera';
const bookingID = urlParams.get('bookingID') || '317230';
const restaurantName = urlParams.get('restaurantName') || 'The White Room.';
const restaurantLocation = urlParams.get('restaurantLocation') || 'Church Street, Bangalore.';
const selectedTables = urlParams.get('selectedTables') || 'Family Tables: 2 Couple Tables: 4';
const bookingDate = urlParams.get('bookingDate') || '2025-04-28';
const bookingTime = urlParams.get('bookingTime') || '12:00';
        ...
        <body>
            <div class="invoice-container">
                ...
                <div class="section">
                    ...
                    <strong>Restaurant Location:</strong> ${restaurantLocation}<br>
                    <strong>Table Numbers:</strong> ${selectedTables}<br>
