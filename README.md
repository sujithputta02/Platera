...
3. Open `Public/index.html` in your web browser to start the application
...
### Restaurant Page
![Restaurant Page](./restuarantpage.png)

### Restaurant Booking Form
![Restaurant Booking Form](./restuarantbookingform.png)
